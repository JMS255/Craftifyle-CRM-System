...
function HeroMoney({ amount, color = 'var(--money)' }: { amount: number; color?: string }) {
  return (
    <div className="flex items-baseline gap-0.5 leading-none">
      <span className="font-semibold" style={{ fontSize: '0.75rem', color, opacity: 0.6 }}>₱</span>
      <span className="font-bold tabular text-3xl md:text-5xl" style={{ lineHeight: 1, color }}>
        {fmtAbbrev(amount)}
      </span>
    </div>
  )
