    ...
    >
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-bold text-white">Craftifyle CRM</h1>
          <p className="text-sm mt-1" style={{ color: '#4a4a6a' }}>Sign in to your dashboard</p>
        </div>
        ...
        <p className="text-center text-xs mt-4" style={{ color: '#2a2a3a' }}>
